...
class FoodForm(FlaskForm):
    ...
    amount = SelectField('How much did you eat?', choices=[(
        '1', 'a little'), ('2', 'some'), ('3', 'a lot')], validators=[InputRequired()])
    feeling = SelectField('choose one', choices=[
                          ('1', 'bad'), ('2', 'okay'), ('3', 'great')], validators=[InputRequired()])
...
class SearchAddForm(FlaskForm):
    search_food_name = StringField(
        'Search from your foods.', validators=[InputRequired()])
...
class UpdateFoodForm(FlaskForm):
    ...
    feeling = SelectField('choose one', choices=[
                          ('1', 'bad'), ('2', 'okay'), ('3', 'great')])
    symptoms = MultiCheckboxField('Symptom', coerce=int)


class SearchForm(FlaskForm):
    food_name_condition = StringField(
        'Search for food data', validators=[InputRequired()])
